package by.bsuir.growpathserver.notification.infrastructure.helper;
...
import by.bsuir.growpathserver.notification.application.exception.ObjectStorageException;
...
public class MinioHelper {
    ...
    public void initBucket(String bucketName) {
        try {
            ...
            throw new ObjectStorageException("Error initializing bucket", exception);
        }
    }
    ...
    public Resource download(String bucket, String key) {
        try {
            ...
            throw new ObjectStorageException("Error downloading file from MinIO", exception);
        }
    }
    ...
    public byte[] downloadBytes(String bucket, String key) {
        try (InputStream stream = minioClient.getObject(
            ...
            log.error("Error downloading bytes from {}/{}", bucket, key, exception);
            throw new ObjectStorageException("Error downloading file from MinIO", exception);
        }
    }
    ...
    private String getPresignedUrl(String bucket, String key, int expirationInSeconds, Method method) {
        try {
            ...
            throw new ObjectStorageException("Error creating presigned URL", exception);
        }
    }
}
